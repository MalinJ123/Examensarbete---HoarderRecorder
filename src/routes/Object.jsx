...
export const Object = () => {
  ...
  return (
    <section className="object__section section--spacer">
      ...
      <div className="start__container">
        ...
        <input id="search__input" className="search__input-text" type="text" placeholder="Sök efter objekt" />
      ...
      <section className="objects__section">

        {
          [...Array(17)].map((_, index) => (
              <div className="object__container" key={index}>

                <div className="object__box" onClick={() => navigate("/show-object")}>

                    <img className="object__image" src={storm} alt="Objekt bild" />

                </div>

                <div className="object__info-container">

                  <div className="object__info" onClick={() => navigate("/show-object")}>
  ...
  <dialog className="dialog__context-menu" ref={dialogContextMenuRef}>
    ...
    <section className="clickable__overlay clickable__overlay--menu" onClick={() => stateDialogContextMenu(false)}>
      ...
      <div className="dialog__container" onClick={(event) => (event.stopPropagation())}>
        ...
        <div className="dialog__action-bar">
          ...
          <h1 className="dialog__title dialog__title--menu"><span className="material-symbols-outlined">emoji_objects</span> <span>Storms</span></h1>
    ...
    <div className="dialog__container" onClick={(event) => (event.stopPropagation())}>
      ...
      <h1 className="dialog__title standard__title">Vill du radera objektet?</h1>
