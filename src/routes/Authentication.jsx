...
export const Authentication = () => {
  const { username, userPassword, isUserLoggedIn, setIsUserLoggedIn } =
    ...
    <section className="auth__splashscreen">
      {selectView === "register" ? (
        <Register
          ...
          registerOrLoginUserGoToStart={registerOrLoginUserGoToStart}
        />
      ) : (
        <Login
          handleViewChange={handleViewChange}
    ...
    <section className="auth__section">
      ...
      <form className="form__container">
        ...
        <div className="form-button__group">
          <button
            type="submit"
            className="gray__button"
            onClick={() => registerOrLoginUserGoToStart("register")}
          >
            Registrera
          </button>
      ...
      <form className="form__container">
        ...
        <div className="form-button__group">
          ...
          <button
            type="submit"
            className="gray__button"
            onClick={() => registerOrLoginUserGoToStart("login")}
          >
            Logga in
          </button>
        </div>
