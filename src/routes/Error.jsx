...
export const Error = () => {
    ...
    return (
        <section className="error__section">
            ...
            <p className="standard__text">Vänligen kontrollera sökvägen eller navigera tillbaka till startsidan. Om du har navigerat dig rätt och kontrollerat sökvägen, kan det vara så att vi har problem med servern eller har vi tagit bort en specific resurs eller vy.</p>
